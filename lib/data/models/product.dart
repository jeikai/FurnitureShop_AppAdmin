...
class Product {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'is_hot': this.isHot,
      'is_deleted':
          (this.isDeleted != null) ? Timestamp.fromDate(this.isDeleted!) : null,
      'link_ar': this.linkAR
    };
  }
  ...
  factory Product.fromJson(Map<String, dynamic> data, String? id) {
    return Product(
      ...
      weight:
          data["weight"] != null ? double.parse(data["weight"].toString()) : 0,
      category: data['category'] ?? "",
      imageColorTheme: data["image_color_theme"] != null
          ? Product().fromString(List<String>.from(data["image_color_theme"]))
          : [],
      search: List<String>.from(data["search"] ?? []),
      isHot: data['is_hot'] != null ? data['is_hot'] as bool : false,
      linkAR: data['link_ar'] != null ? data['link_ar'] as String : null,
      isDeleted: data['is_deleted'] != null
          ? DateTime.tryParse(
              (data["is_deleted"] as Timestamp).toDate().toString())
          : null,
    );
  }
